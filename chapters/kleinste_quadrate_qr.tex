...
\begin{figure*}[h]
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        ...
        % Text Node
        \draw (365,200) node [anchor=west][inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {\( A \begin{pmatrix} \textcolor{customred}{x_1^{opt}} \\ \textcolor{customred}{x_2^{opt}} \end{pmatrix} \in \textcolor{customgreen}{\text{Bild}A} \) };
        % Text Node
        ...
        % Text Node
        \draw (375,90) node [anchor=west][inner sep=0.75pt]  [color={rgb, 255:red, 0; green, 0; blue, 0 }  ,opacity=1 ] [align=left] {\( \textcolor{customorange}{r} =  A \begin{pmatrix} \textcolor{customred}{x_1^{opt}} \\ \textcolor{customred}{x_2^{opt}} \end{pmatrix} - \textcolor{customblue}{c} \)};
        % Text Node
...
Der rote Vektor \( \textcolor{customred}{x^{opt}} \) repräsentiert hier die optimale Lösung, welche den kürzesten Residuenvektor \( \textcolor{customorange}{r} \) hat und im Bild von \( A \) liegt. Grafisch können wir hier auch sehen, dass der Vektor \( \textcolor{customorange}{r} \) minimal ist, wenn er orthogonal zum \( \textcolor{customgreen}{\text{Bild}A} \) ist. Für die optimale Lösung muss also gelten:

\begin{equation*}
    A y \ \perp \ r \ , \quad \forall y.
\end{equation*}
