...
\begin{figure}[h]
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_01}
        \begin{tikzpicture}
                \begin{axis}[
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_02}
        \begin{tikzpicture}
                \begin{axis}[
                    tick label style={font=\footnotesize},
                    width=5.5cm,
    ...
    \begin{minipage}{0.32\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_03}
        \begin{tikzpicture}
                \begin{axis}[
                    tick label style={font=\footnotesize},
                    width=5.5cm,                    
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.39\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_04}
        \begin{tikzpicture}
            \begin{axis}[
                tick label style={font=\footnotesize},
                width=5.5cm,
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.39\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_05}
        \begin{tikzpicture}
            \begin{axis}[
                tick label style={font=\footnotesize},
                width=5.5cm,
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.39\textwidth}
        \centering
        \tikzsetnextfilename{quad_form_06}
        \begin{tikzpicture}
            \begin{axis}[
                tick label style={font=\footnotesize},
                width=5.5cm,                    
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \tikzsetnextfilename{reine_quad_form_01}
        \begin{tikzpicture}
            \begin{axis}[
                tick label style={font=\footnotesize},
                xlabel={$x_1$},
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \tikzsetnextfilename{reine_quad_form_02}
        \begin{tikzpicture}
            \begin{axis}[
                tick label style={font=\footnotesize},
                xlabel={$x_1$},
...
\begin{figure}[h]
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \tikzsetnextfilename{reine_quad_form_03}
        \begin{tikzpicture}
            \begin{axis}[
                width=6.5cm,
                xlabel={$x_1$},
                ...
                \addplot3[
                    contour filled={
                        number=50, % Number of contour levels
                    },
                    domain=-5:5,
                    domain y=-5:5,
                    samples=75,
    ...
    \begin{minipage}{0.4\textwidth}
        \centering
        \tikzsetnextfilename{reine_quad_form_04}
        \begin{tikzpicture}
            \begin{axis}[
                width=6.5cm,
                xlabel={$x_1$},
